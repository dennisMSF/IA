...
def point_valid(pt,r,a,samples,nx,ny,cells):
...
def get_point(k, refpt,r,a,samples,nx,ny,cells,width,height):
    ...
    while i < k:
        ...
        if not (0 <= pt[0] < width and 0 <= pt[1] < height):
            ...
            continue
        if point_valid(pt,r,a,samples,nx,ny,cells):
            return pt
        i += 1
...
def get_good_points(num_points,distance_point):
    ...
    while len(samples) < num_points:
        ...
        pt = get_point(k, refpt,r,a,samples,nx,ny,cells,width,height)
        if pt:
